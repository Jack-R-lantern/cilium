...
/* enable_nodeport is enabled automatically when kpr or bpfMasquerade is enabled. */
NODE_CONFIG(bool, enable_nodeport, "")

NODE_CONFIG(bool, enable_nodeport_acceleration, "")